export const HELP = {
  ...
  "settings.systemHealth":
    "Admin-only SQL, Blob, OCR queue, Document Intelligence, and OCR pipeline checks. Modes and reachability only — never connection strings, keys, or other secrets.",
