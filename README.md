...
- **Settings nest:** Settings → **System** (singular) → Software / Users / API. One child active at a time. Child label **Software** (never Systems / Workspace / County / CAMA). Parent Settings is not highlighted with a child. `/settings` child is **System**.
...
- **Settings nest:** Settings → **System** (singular) / Software / Users / API. Top-level Settings group, `/settings`, and Admin permission stay the same. Child label **Software** (never Systems / Workspace / County / CAMA).
