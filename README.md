...
- **GIS chrome (1:1 shell):** Live GIS custom CSS is imported verbatim (`spa/src/gis-shell.css` from `appgisdashboard` `index-Dnm45b_t.css`) plus Ant 5 layout/menu/card rules. Dark sider `#001529`, blue `#1890FF` active, white utility header, `filter-toolbar` + `kpi-card`. Table rows 32px. Not a token-only restyle. Gold Export is a page action, not the shell.
