...
namespace DeedAi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260910040000_Phase6AiExtract")]
    partial class Phase6AiExtract
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeedAi.Domain.Entities.DeletePolicySettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("WhoCanDelete")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                        .HasDefaultValue("AllEditors");

                    b.HasKey("Id");

                    b.ToTable("DeletePolicySettings", null, t =>
                        {
                            t.HasCheckConstraint("CK_DeletePolicySettings_WhoCanDelete", "WhoCanDelete IS NULL OR WhoCanDelete IN ('AllEditors','AdminOnly')");
                        });
                });
            ...
            modelBuilder.Entity("DeedAi.Domain.Entities.Document", b =>
                {
                    ...
                    b.Property<string>("AiRawBlobPath")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
                    ...
                    b.Property<string>("ExtractConfidenceJson")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("DeedAi.Domain.Entities.EmailSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("LastFailAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<bool>("VerifyRequired")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("EmailSettings", null, t =>
                        {
                            t.HasCheckConstraint("CK_EmailSettings_Mode", "Mode IN ('SendGrid','Smtp')");
                        });
                });

            modelBuilder.Entity("DeedAi.Domain.Entities.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DeedAi.Domain.Entities.SoftwareClientConfig", b =>
                {
                    ...
                    b.Property<int?>("CertifiedYear")
                        .HasColumnType("int");

                    b.Property<int?>("DefaultYear")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GranteeCombiner")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                    ...
                    b.Property<string>("LookupImageCode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                    ...
                    b.Property<string>("PushImageCode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                    ...
                    b.Property<string>("SalesRatioCode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
            ...
            modelBuilder.Entity("DeedAi.Domain.Entities.SoftwareImageCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("UseOnLookup")
                        .HasColumnType("bit");

                    b.Property<bool>("UseOnPush")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("SoftwareImageCodes", (string)null);
                });
