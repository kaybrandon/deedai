...
public sealed class HardeningTests : IClassFixture<TestAppFactory>
{
    ...
    public void All_ef_migrations_are_discoverable_including_phase4()
    {
        ...
        Assert.Contains(DocumentListFieldNullDefaults.MigrationId, ids);
        Assert.True(
        ...
        Assert.True(
            string.CompareOrdinal("20260909220000_DocumentListFields", DocumentListFieldNullDefaults.MigrationId) < 0);
    }
